    ...
    public partial class FaceEditor : UserControl
    {
       ...
       //     if ((currentSliceIndex > 0) && (currentSliceIndex < (face.HorizontalBezierCurveList.Count - 1))) ;
        ...
        public void Initialize()
        {
            ...
            face.Material.SetAmbientColor(Color.FromArgb(255, 205, 148));  // Typical skin color approximation
            face.Material.SetDiffuseColor(Color.FromArgb(255, 205, 148));  // Typical skin color approximation
            face.Material.SetSpecularColor(Color.White);
            face.Material.Shininess = 50;//  20;
            int numberOfLongitudePoints = int.Parse(numberOfLongitudePointsTextBox.Text);
            face.Generate(new List<double>() { numberOfLongitudePoints });
            scene.AddObject(face);
            face.Material.SetAmbientColor(Color.FromArgb(200, 100, 255, 100));  // Typical skin color approximation
            face.Material.SetDiffuseColor(Color.FromArgb(200, 100, 255, 100));  // Typical skin color approximation
            face.Material.SetSpecularColor(Color.FromArgb(200, 100, 255, 100));
            face.Material.Shininess = 20;//  20;
