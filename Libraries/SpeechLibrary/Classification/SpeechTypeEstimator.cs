...
namespace SpeechLibrary.Classification
{
    [DataContract]
    public class SpeechTypeEstimator
    {
        ...
        private const double DEFAULT_SILENCE_THRESHOLD = 5000; // 2500;
        private const double DEFAULT_ZERO_CROSSING_RATE_THRESHOLD = 0.15;
        ...
        private List<double> energyRatioList;
        private List<double> zeroCrossingsRateList;
            ...
            //                                 double energyThreshold, double silenceThreshold)
        {
            ...
            {
                energyRatioList.Add(0);
                zeroCrossingsRateList.Add(zeroCrossingRate);
            ...
            else
            {
                ...
                energyRatioList.Add(energyRatio);
                zeroCrossingsRateList.Add(zeroCrossingRate);
                if ((energyRatio > lowPassRatioThreshold) && (zeroCrossingRate < zeroCrossingRateThreshold))  // && (averageEnergy > energyThreshold) // NOTE: Changed 20190528
                {
                    return SpeechType.Voiced;
                }
              /*  else if (zeroCrossingRate < zeroCrossingRateThreshold)  // Change?  // Not needed?
                {
                    return SpeechType.Voiced;
                }   */ 
                else
        ...
        {
            energyRatioList = new List<double>();
            zeroCrossingsRateList = new List<double>();
            ...
            energyRatioList.Insert(0, 0);
            zeroCrossingsRateList.Insert(0, 0);
        ...
        public List<double> EnergyRatioList
        {
            get { return energyRatioList; }
        }

        public List<double> ZeroCrossingsRateList
        {
            get { return zeroCrossingsRateList; }
        }
