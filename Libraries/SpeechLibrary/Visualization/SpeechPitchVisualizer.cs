...
using SpeechLibrary.Classification;
using SpeechLibrary.Modification.TDPSOLA;

namespace SpeechLibrary.Visualization
{
    public partial class SpeechPitchVisualizer : HorizontalScrollableZoomControl
    {
