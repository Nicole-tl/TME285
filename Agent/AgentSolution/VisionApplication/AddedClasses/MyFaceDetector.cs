...
{
    public class MyFaceDetector : FaceDetector
    {
        ...
        protected override void ProcessBitmap(Bitmap bitmap)
        {
            if (bitmap != null)
            {
                ...
                // INVERT BINARY IMAGE
                skinPixelDetectionProcessor.ConvertToStandardGrayscale();
                double binarizationThreshold = 80;
                skinPixelDetectionProcessor.Binarize(binarizationThreshold);

                // DIALATION & EROSION - Convolve in image processing
                List<double> convolutionMask1 = new List<double>();
                convolutionMask1.Add(0);
                convolutionMask1.Add(1);
                convolutionMask1.Add(0);
                List<double> convolutionMask2 = new List<double>();
                convolutionMask2.Add(1);
                convolutionMask2.Add(1);
                convolutionMask2.Add(1);
                List<double> convolutionMask3 = new List<double>();
                convolutionMask3.Add(0);
                convolutionMask3.Add(1);
                convolutionMask3.Add(0);
                List<List<double>> convolutionMask = new List<List<double>>();
                convolutionMask.Add(convolutionMask1);
                convolutionMask.Add(convolutionMask2);
                convolutionMask.Add(convolutionMask3);

                skinPixelDetectionProcessor.Convolve(convolutionMask);

                List<double> convolutionMask4 = new List<double>();
                convolutionMask4.Add(1);
                convolutionMask4.Add(1);
                convolutionMask4.Add(1);
                List<double> convolutionMask5 = new List<double>();
                convolutionMask5.Add(1);
                convolutionMask5.Add(1);
                convolutionMask5.Add(1);
                List<double> convolutionMask6 = new List<double>();
                convolutionMask6.Add(1);
                convolutionMask6.Add(1);
                convolutionMask6.Add(1);
                List<List<double>> convolutionMask7 = new List<List<double>>();
                convolutionMask7.Add(convolutionMask1);
                convolutionMask7.Add(convolutionMask2);
                convolutionMask7.Add(convolutionMask3);

                skinPixelDetectionProcessor.Convolve(convolutionMask7);
